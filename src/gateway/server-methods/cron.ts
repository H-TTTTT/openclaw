...
function cronRunHistoryPageFilters(params: CronRunsRequestParams) {
  return {
    limit: params.limit,
...
/** Gateway request handlers for cron jobs and cron run-history access. */
